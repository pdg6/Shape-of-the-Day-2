...
export const DummyDataControls: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-24 md:bottom-5 right-2 md:right-5 p-3 md:p-4 bg-gray-800 rounded-xl border-2 border-brand-accent text-white min-w-[200px] md:min-w-[250px] z-toast">
