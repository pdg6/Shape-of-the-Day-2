                    ...
                    <div className="bg-brand-lightSurface dark:bg-brand-darkSurface border-2 border-gray-200 dark:border-gray-700 rounded-b-lg rounded-tr-lg p-4 space-y-4 flex-1 flex flex-col -mt-[2px] relative z-40">
                        ...
                        <div className="space-y-3 sm:space-y-0">
                            ...
                            <div className="grid grid-cols-2 gap-3 sm:hidden">
                                ...
                                <button
                                    ...
                                    className={`relative w-full px-3 py-2.5 rounded-lg border-2 transition-all duration-200 bg-brand-lightSurface dark:bg-brand-darkSurface border-gray-200 dark:border-gray-700 font-medium text-sm cursor-pointer hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800/50 flex items-center justify-center gap-1.5 ${activeFormData.endDate ? 'text-brand-textDarkPrimary dark:text-brand-textPrimary' : 'text-gray-400 dark:text-gray-500'}`}
                                >
                                    <input
                            ...
                            <div className="hidden sm:grid sm:grid-cols-4 sm:gap-4">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className={`w-full pl-9 pr-4 py-2.5 rounded-lg border-2 transition-all duration-200 bg-brand-lightSurface dark:bg-brand-darkSurface border-gray-200 dark:border-gray-700 font-medium text-sm cursor-pointer hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800/50 focus:outline-none focus:border-brand-accent focus:ring-2 focus:ring-brand-accent/20 text-left ${activeFormData.startDate ? 'text-brand-textDarkPrimary dark:text-brand-textPrimary' : 'text-gray-400 dark:text-gray-500'}`}
                                    >
                                        <input
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className={`w-full pl-9 pr-4 py-2.5 rounded-lg border-2 transition-all duration-200 bg-brand-lightSurface dark:bg-brand-darkSurface border-gray-200 dark:border-gray-700 font-medium text-sm cursor-pointer hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800/50 focus:outline-none focus:border-brand-accent focus:ring-2 focus:ring-brand-accent/20 text-left ${activeFormData.endDate ? 'text-brand-textDarkPrimary dark:text-brand-textPrimary' : 'text-gray-400 dark:text-gray-500'}`}
                                    >
                                        <input
                                            ref={dueDateInputRef}
                                            type="date"
                        ...
                        <div className="flex-1 flex flex-col space-y-4 min-h-0 overflow-hidden">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-4 border-t border-gray-200/50 dark:border-gray-700/50 flex-shrink-0">
                                ...
                                <div className="relative py-2.5 px-4 rounded-md border-2 border-gray-200 dark:border-gray-700 bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 group cursor-pointer">
                                    <input
                                        ref={fileInputRef}
                                        type="file"
                                        multiple
                            ...
                            <div className="pt-4 border-t border-gray-200 dark:border-gray-700 animate-fade-in flex-shrink-0">
                                ...
                                <div className="flex items-center gap-3 mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
                                    ...
                                    <button
                                        ...
                                        className="py-2.5 px-4 rounded-md border-2 border-gray-200 dark:border-gray-700 text-gray-500 font-medium hover:bg-gray-100 dark:hover:bg-gray-800 hover:border-gray-300 dark:hover:border-gray-600 transition-all"
                                    >
                                        Cancel
                                    </button>
                                </div>
